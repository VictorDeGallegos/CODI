...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Suma del primer y último elemento del arreglo: "
                + (listaOrdenada[0] + listaOrdenada[listaOrdenada.length - 1]));

        // Mostrar en consola el mensaje "Existe cien" en dado caso el arreglo almacene
        // por los menos un cien.
